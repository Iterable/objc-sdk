...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Ilya Brin" => "ilya@iterable.com" }
  ...
  s.source       = { :git => "https://github.com/Iterable/iterable-ios-sdk.git", :tag => "0.1.0" }
  ...
  s.source_files  = "Iterable-iOS-SDK/*.{h,m}"
